...
def jsontoM3U8(path,wfile):
    ...
    keylist3, bookFaillist3, key2list3, bookSuccesslist3 = jsonToList(os.path.join(path,'legado'),'bookSourceUrl','ruleBookContent.content')    
    ...
    print(len(keylist3))
    print(len(set(keylist3)))
    print(len(key2list3))
    print(len(set(key2list3)))             
    print(len(bookFaillist3))
    print(len(bookSuccesslist2))
...
if __name__ == '__main__':
    ...
    jsontoM3U8("e:\\workspace\\pydemo","fail3.1")