...
print(ComputerVisionClient)
remote_image_url = "https://raw.githubusercontent.com/Azure-Samples/cognitive-services-sample-data-files/master/ComputerVision/Images/landmark.jpg"
remote_image_url = "https://www.assdrty.com/tupian/forum/202101/19/120800akaeax955ukal7fa.jpg"
'''
...
# Call API
description_results = computervision_client.describe_image(remote_image_url,language='zh' )
...
categorize_results_remote = computervision_client.analyze_image(remote_image_url , remote_image_features,language='zh')
...
remote_image_url_objects = "https://jp.netcdn.space/digital/video/ssni00976/ssni00976pl.jpg"
# Call API with URL
detect_objects_results_remote = computervision_client.detect_objects(remote_image_url_objects,language='zh')
...
# remote_image_url = "https://s02.mifile.cn/assets/static/image/logo-footer.png"
# Select the visual feature(s) you want
remote_image_features = ["brands"]
# Call API with URL and features
detect_brands_results_remote = computervision_client.analyze_image(remote_image_url, remote_image_features,language='zh')
...
remote_image_url_faces = "https://jp.netcdn.space/digital/video/ssni00976/ssni00976pl.jpg"
# Select the visual feature(s) you want.
remote_image_features = ["faces"]
# Call the API with remote URL and features
detect_faces_results_remote = computervision_client.analyze_image(remote_image_url_faces, remote_image_features,language='zh')
...
remote_image_adult_url = "https://www.assdrty.com/tupian/forum/202101/19/120800akaeax955ukal7fa.jpg"
# Select the visual feature(s) you want
remote_image_features = ["adult"]
# Call API with URL and features
detect_adult_results_remote = computervision_client.analyze_image(remote_image_adult_url, remote_image_features,language='zh')
...
remote_image_color_url = "https://www.assdrty.com/tupian/forum/202101/19/120800akaeax955ukal7fa.jpg"
# Select the feature(s) you want
remote_image_features = ["color"]
# Call API with URL and features
detect_color_results_remote = computervision_client.analyze_image(remote_image_color_url, remote_image_features,language='zh')
...
remote_image_url_celebs = "https://i1.mifile.cn/f/i/18/about/about_3.jpg"
# Call API with content type (celebrities) and URL
detect_domain_results_celebs_remote = computervision_client.analyze_image_by_domain("celebrities", remote_image_url_celebs,language='zh')
...
remote_image_url_type = "https://jp.netcdn.space/digital/video/ssni00975/ssni00975pl.jpg"
# Select visual feature(s) you want
remote_image_features = [VisualFeatureTypes.image_type]
# Call API with URL and features
detect_type_results_remote = computervision_client.analyze_image(remote_image_url_type, remote_image_features,language='zh')
...
recognize_handw_results = computervision_client.read(remote_image_handw_text_url, language='en',raw=True)
...
while True:
    ...
    if get_handw_text_results.status not in ['notStarted', 'running']:
        print('not start and not running')
        break
    time.sleep(1)
...
# local_image = open("book/ocrimg4/0010005960.png", "rb")
...
# local_image_path_landmark = "book/ocrimg4/0010005960.png"
...
# Open local image
# local_image_path_type = "book/ocrimg4/0010005960.png"
...
# local_image_path_objects = "book/ocrimg4/0010005960.png"
...
# # Open image file
# local_image_path_shirt = "book/ocrimg4/0010005960.png"
...
# local_image_path_thumb = "book/ocrimg4/0010005960.png"
...
# local_image_handwritten_path = "book/ocrimg4/0010005960.png"
# # Open the image
...
local_image_printed_text_path = "book/ocrimg4/0010005960.png"
local_image_printed_text = open(local_image_printed_text_path, "rb")

ocr_result_local = computervision_client.recognize_printed_text_in_stream(local_image_printed_text,language='zh-Hans')
...
remote_printed_text_image_url = "https://raw.githubusercontent.com/guibiaoguo/ssr-public/master/1449540407_383352%20(1).png"
# remote_printed_text_image_url = "http://hdyp.net/toimg/data/8637348340.png"

ocr_result_remote = computervision_client.recognize_printed_text(remote_printed_text_image_url,language='zh-Hans')
